...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=zahoor9&repo=tanzu-java-web-app",
  "projectName" : "tanzu-java-web-app",
  "repositoryPrefix" : "us.gcr.io/za-tanzu"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->us.gcr.io/za-tanzu]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=zahoor9&repo=tanzu-java-web-app'
